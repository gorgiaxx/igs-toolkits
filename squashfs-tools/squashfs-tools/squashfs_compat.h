...
struct squashfs_super_block_22_v2 {
	...
	unsigned int		block_size_1:16;
	unsigned int		block_log:16;
	unsigned int 		igs_fs_version_major;
	unsigned int 		igs_fs_version_minor;
	unsigned int		major_number;
	unsigned int		minor_number;
	unsigned int		inodes;
	unsigned int		bytes_used;
...
typedef struct squashfs_super_block_22_v1 squashfs_super_block_22_v1;
typedef struct squashfs_super_block_22_v2 squashfs_super_block_22_v2;
